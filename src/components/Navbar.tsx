        ...
        <AnimatePresence>
          ...
          {isNavVisible && (
            <motion.nav
              ...
              className="absolute top-[7px] left-1/2 z-[1] flex -translate-x-1/2 justify-between gap-x-[109px] rounded-[9px] bg-[#1E1E1E] px-[31.5px] py-[11.5px] font-grotesk-semiBold text-[16px] leading-[17.6px] text-white headerShadow lg:top-[15px] lg:gap-x-[123px] lg:py-[16.2px] lg:text-[17px] lg:leading-[18.5px]"
            >
              {/* Left Links */}
